export const TRANSLATIONS = {
  en: {
    ...
    chatGeneratingVisual: 'Adding a visual example',
    ...
    auth: {
      ...
      email: 'School Email',
      emailHint: 'Format: username@tongji.edu.cn',
      ...
      feedbackCopy: 'Copy',
      welcomeGuestIntro: 'Discrete mathematics is easier when ideas connect. After you log in, start with a concept, a problem, or an image, and Xiaoli will help you work through it with course materials, clear examples, formulas, and diagrams.',
      welcomeGuestPrompt: 'Log in, then enter your discrete math question here...',
  ...
  zh: {
    ...
    auth: {
      ...
      signupTitle: '创建账号',
      email: '学校邮箱',
      emailHint: '格式：用户名@tongji.edu.cn',
      code: '验证码',
      sendCode: '获取验证码',
      name: '姓名',
      password: '密码',
      ...
      feedbackCopy: '复制',
      welcomeGuestIntro: '离散数学不必只靠记忆。登录后，你可以从一个概念、一道题或一张图片开始，小离会结合课程资料，用清晰的例子、公式和图示帮你一步步理清思路。',
      welcomeGuestPrompt: '登录后，在这里输入你的离散数学问题...',
